...
const Conatct = () => {
  return (
      <section className="w-full h-1/6   bg-slate-800"> 
        <div className="w-5/6 mx-auto h-[500px]  my-1 md:flex-row flex-col-reverse md:flex md:h-[400px] md:items-center md:justify-around">
          <div className="w-5/6 h-2/6  md:w-5/12 md:h-4/5 md:m-3 mx-auto my-2 p-3">
            <h2 className="w-5/6 md:font-extrabold md:w-64 md:mt-9 md:ml-4 my-1 h-2/6  capitalize text-slate-200 font-bold text-sm p-1 md:text-xl">
          ...
          <div className="h-3/6 w-5/6 rounded-md  mx-auto my-2 md:my-3 md:w-6/12 md:h-4/5">
          <img src={conatctImage} alt="contactimage"  className='rounded-md'/>
          </div>
        </div>
